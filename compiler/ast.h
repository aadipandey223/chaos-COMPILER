...
typedef enum {
    ...
    NODE_RETURN, NODE_IF, NODE_WHILE, NODE_FOR,
    NODE_VAR_DECL, NODE_EXPR_STMT,
    NODE_BINARY_OP, NODE_UNARY_OP, NODE_ASSIGN,
    NODE_NUMBER, NODE_STRING_LITERAL, NODE_IDENT, NODE_CALL,
    NODE_POINTER_DECL, NODE_ADDRESS_OF, NODE_DEREF,
    NODE_ARRAY_DECL, NODE_ARRAY_ACCESS,
    NODE_STRUCT_DECL, NODE_MEMBER_ACCESS, NODE_CAST_EXPR
} NodeType;
